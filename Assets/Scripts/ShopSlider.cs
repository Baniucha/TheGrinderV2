...
//SCRIPT RESPONSIBLE FOR SLIDER THAT ALLOWS PLAYER TO CHOOSE HOW MUCH ITEMS PLAYER WANTS TO SELL
public class ShopSlider : MonoBehaviour
{
    ...
    //BELOW FUNCTIONS SET AMOUNT OF A GOOD
    //CLICK ON WOOD, SAND ETC AND IT SETS THE VALUE
    //ENABLE SLIDER
    public void Wood()
    {
    ...
    //CONTINUE OF PREVIOUS FUNCTIONS
    //SUBTRACT GOODS AND GIVES GOLD
